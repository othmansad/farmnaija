      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex items-center gap-2.5">
            ...
            <span className="font-black text-2xl tracking-tight text-foreground">FarmWise</span>
          </div>
        ...
        <Card className="border-border/50 shadow-xl">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription className="text-center text-xs">
              {isLogin
                ? "Access your farm data across all devices"
          ...
          <CardContent className="space-y-4">
            ...
            <form onSubmit={handleEmailAuth} className="space-y-3">
              ...
              <Button type="submit" className="w-full h-11 font-black text-sm" disabled={loading}>
        ...
        <p className="text-center text-[10px] text-muted-foreground">
          🌾 FarmWise Nigeria — Smart farming for every farmer
        </p>
      </div>
    </div>
  );
